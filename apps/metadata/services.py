...
# Handles bulk set, auto-fill from OCR, export (CSV/JSON),
# and metadata history recording.
# =============================================================================
import csv
import json
...
class MetadataService:
    ...
    def set_value(document: Document, field: MetadataField,
                  ...
                  auto_filled: bool = False, change_note: str = '') -> DocumentMetadata:
    ...
    def bulk_set(document: Document, field_value_map: dict,
        ...
        """Set multiple metadata values at once. field_value_map = {field_name: value}."""
        results = []
    ...
    def auto_fill_from_ocr(document: Document, ocr_data: dict, user=None):
        ...
        return MetadataService.bulk_set(
            document, ocr_data, user=user, auto_filled=True
        )

    @staticmethod
    def export_csv(document: Document) -> str:
        """Export document metadata as CSV string."""
    ...
    def get_history(document: Document, field_name: str = None):
        """Return metadata change history for a document, optionally filtered by field."""
