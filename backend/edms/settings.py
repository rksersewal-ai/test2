...
#
# PORT POLICY:
#   Backend  : 8765  (avoids 8000 = DSC Signer on CLW/IR office PCs)
#   Frontend : 4173  (Vite preview port)
# =============================================================================
import os
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'edms.authentication.JWTCookieAuthentication',  # cookie-first, header fallback
    ],
...
# ───────────────────────────────────────────────────────────────────────────
# CORS — LAN-only, credentials (cookies) must be allowed
# ───────────────────────────────────────────────────────────────────────────
